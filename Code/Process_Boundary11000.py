...
# ------------------load DNS data---------------------------------------------
bound_data_path = data_path / 'Boundary flow'
vel_DNS=np.genfromtxt(bound_data_path / "vel_11000_DNS.dat", dtype=None,comments="%")
...
DNS_RSTE = np.genfromtxt(bound_data_path / "bud_11000.prof.txt",comments="%")
